...
import { Shield, GlowBlob, BlurDefs } from "@/components/illustrations/parts";
  ...
  return (
    <section className="relative overflow-hidden py-20">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto flex max-w-4xl items-center justify-center gap-6 lg:gap-10">
          <div className="relative hidden shrink-0 lg:block" aria-hidden="true">
            <svg viewBox="0 0 220 220" className="h-40 w-40 illo-float">
              <BlurDefs />
              <GlowBlob cx={110} cy={110} r={80} opacity={0.35} />
              <Shield cx={110} cy={112} scale={0.8} />
            </svg>
          </div>

          <ScrollFadeIn delayMs={120} className="relative w-full max-w-2xl">
            <button
              type="button"
              onClick={prev}
